...
- 设备 ACL 控制：设备只能访问自己 client_id 对应的 thing/event、thing/service、thing/file、ota/upgrade、ota/version 主题
...
- ACL 规则：允许 client_id 匹配的以下主题 — `thing/event/*`、`thing/service/*`、`thing/file/*`、`ota/upgrade`、`ota/version`
