...
- 参考 `.claude/guides/demo/common-failures.md` 中的常见失败模式，快速匹配已知问题
...
- `.claude/guides/demo/diagnose-guide.md`
- `.claude/guides/demo/e2e-testing.md`
- `.claude/guides/demo/templates/diagnose-report-template-v3-minimal.md`
