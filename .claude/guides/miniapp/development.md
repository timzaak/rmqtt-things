...
相关入口：
- miniapp 规范入口：`guides/miniapp/index.md`
- 测试规则：`guides/miniapp/testing.md`
- 完成前验证：`guides/miniapp/validation.md`
- 验收与模板门禁：`guides/miniapp/quality.md`
- 技术宪法：`guides/miniapp/constitution.md`
- 执行约束：`guides/miniapp/ai-rules.md`
...
如需更完整的 H5 预览、模板门禁或发布前检查，按 `guides/miniapp/testing.md`、`guides/miniapp/validation.md` 和 `guides/miniapp/quality.md` 执行。
