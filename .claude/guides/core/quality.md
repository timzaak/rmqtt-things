...
- 后端验收细则：`.claude/guides/backend/quality.md`
- 前端验收细则：`.claude/guides/frontend/quality.md`
- Demo 验收细则：`.claude/guides/demo/quality.md`

## 5. 执行约束

- 需求语义冲突时，以 `docs/`（PRD + User Stories）为准
- 执行流程与测试约束，以 `.claude/guides/` 与 `AGENTS.md` 为准
- 未经授权不得修改与当前任务无关的文件
