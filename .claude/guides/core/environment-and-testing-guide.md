...
| 任务 | 推荐入口 |
| --- | --- |
| 日常开发环境 | `uv run scripts/dev-start.py` |
...
- Demo：[`e2e-testing.md`](.claude/guides/demo/e2e-testing.md)
- Backend：[`testing.md`](.claude/guides/backend/testing.md)
- Frontend：[`testing.md`](.claude/guides/frontend/testing.md)
- 质量门禁：[`quality.md`](.claude/guides/core/quality.md)
