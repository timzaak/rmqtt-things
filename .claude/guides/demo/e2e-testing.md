...
- POM：[`pom-guide.md`](.claude/guides/demo/pom-guide.md)
- 选择器策略：[`selector-strategy.md`](.claude/guides/demo/selector-strategy.md)
- 维护指南：[`test-maintenance.md`](.claude/guides/demo/test-maintenance.md)
- 调试指南：[`diagnose-guide.md`](.claude/guides/demo/diagnose-guide.md)
