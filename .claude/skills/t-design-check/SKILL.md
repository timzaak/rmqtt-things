...
评分维度、严重级别和报告要求统一参考：`.claude/protocols/design-check-rubric.md`
...
- 规范来源：
  - `.claude/guides/core/environment-and-testing-guide.md`
...
3. 核对设计文档与需求来源的一致性。
4. 核对设计文档与项目规范的一致性。
5. 按 `.claude/protocols/design-check-rubric.md` 检查 API、数据库、前端与测试策略。
6. 生成评分与问题清单。
