...
- `.claude/guides/product/index.md` — 产品规范入口
- `.claude/guides/product/user-story.md` — 用户故事规范
...
- `.claude/guides/product/index.md`
- `.claude/guides/product/user-story.md`
...
- 使用 `.claude/guides/product/user-story.md` 的结构和约束
...
- PRD 至少包含：相关用户故事、范围界定、需求概述、业务规则与状态、功能需求、API 相关约束（如适用）、前端/交互约束（如适用）、已确认决策与待确认假设、参考资料。
