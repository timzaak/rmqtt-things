...
评分、扣分和问题分级统一参考：`.claude/protocols/prd-check-rubric.md`
...
### 3. PRD 检查
按 `.claude/protocols/prd-check-rubric.md` 执行：
...
### 6. 评分计算
按 `.claude/protocols/prd-check-rubric.md` 计算：
...
### 7. 问题分级
问题分级统一参考：`.claude/protocols/prd-check-rubric.md`

### 8. 输出要求
- 控制台摘要和报告结构统一参考：`.claude/protocols/prd-check-rubric.md`
...
- `.claude/guides/product/prd.md` - PRD 分层与禁止内容规范
