...
Runtime boundaries: `.claude/protocols/runtime-boundaries.md`

Orchestrates the complete test-fix-retest cycle for a target Rust backend using `cargo nextest`.
Detailed scope selection and escalation rules live in `.claude/protocols/backend-test-execution.md`.
...
Map changes to test commands using `.claude/protocols/backend-test-execution.md`:
...
## Conflict Resolution
Follow `.claude/protocols/backend-test-execution.md`:
