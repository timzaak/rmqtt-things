...
#[openapi(
    ...
    paths(
        ...
        admin_handlers::set_property_desired,
        admin_handlers::get_property_shadow,
    ...
    components(
        schemas(
            ...
            crate::api::admin_models::SetDesiredRequest,
            crate::api::admin_models::SetDesiredResponse,
            crate::api::admin_models::ShadowView,
            crate::api::admin_models::ShadowQuery,
            ...
            crate::db::models::PropertyDesired,
